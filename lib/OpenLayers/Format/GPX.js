...
OpenLayers.Format.GPX = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    */
    ...
    appendAttributesNode: function(node, feature) {
        ...
        var cmt = this.createElementNSPlus('gpx:cmt');
        cmt.appendChild(this.createTextNode(
            feature.attributes.cmt));
        node.appendChild(cmt);
        var src = this.createElementNSPlus('gpx:src');
        src.appendChild(this.createTextNode(
            feature.attributes.src));
        node.appendChild(src);
        var type = this.createElementNSPlus('gpx:type');
        type.appendChild(this.createTextNode(
            feature.attributes.type));
        node.appendChild(type);
        var extensions = this.createElementNSPlus('gpx:extensions');
        extensions.appendChild(this.createTextNode(
            feature.attributes.extensions));
        node.appendChild(extensions);
        var link = this.createElementNSPlus('gpx:link');
        link.appendChild(this.createTextNode(
            feature.attributes.link));
        node.appendChild(link);

        if (feature.geometry.CLASS_NAME == "OpenLayers.Geometry.Point") {
            var ele = this.createElementNSPlus('gpx:ele');
        	ele.appendChild(this.createTextNode(
                feature.attributes.ele));
            node.appendChild(ele);
        	var time = this.createElementNSPlus('gpx:time');
        	time.appendChild(this.createTextNode(
                feature.attributes.time));
            node.appendChild(time);
        	var magvar = this.createElementNSPlus('gpx:magvar');
        	magvar.appendChild(this.createTextNode(
                feature.attributes.magvar));
            node.appendChild(magvar);
        	var geoidheight = this.createElementNSPlus('gpx:geoidheight');
        	geoidheight.appendChild(this.createTextNode(
                feature.attributes.geoidheight));
            node.appendChild(geoidheight);
        	var sym = this.createElementNSPlus('gpx:sym');
        	sym.appendChild(this.createTextNode(
                feature.attributes.sym));
            node.appendChild(sym);
        	var fix = this.createElementNSPlus('gpx:fix');
        	fix.appendChild(this.createTextNode(
                feature.attributes.fix));
            node.appendChild(fix);
        	var sat = this.createElementNSPlus('gpx:sat');
        	sat.appendChild(this.createTextNode(
                feature.attributes.sat));
            node.appendChild(sat);
        	var vdop = this.createElementNSPlus('gpx:vdop');
        	vdop.appendChild(this.createTextNode(
                feature.attributes.vdop));
            node.appendChild(vdop);
        	var hdop = this.createElementNSPlus('gpx:hdop');
        	hdop.appendChild(this.createTextNode(
                feature.attributes.hdop));
            node.appendChild(hdop);
        	var pdop = this.createElementNSPlus('gpx:pdop');
        	pdop.appendChild(this.createTextNode(
                feature.attributes.pdop));
            node.appendChild(pdop);
        	var ageofdgpsdata = this.createElementNSPlus('gpx:ageofdgpsdata');
        	ageofdgpsdata.appendChild(this.createTextNode(
                feature.attributes.ageofdgpsdata));
            node.appendChild(ageofdgpsdata);
        	var dgpsid = this.createElementNSPlus('gpx:dgpsid');
        	dgpsid.appendChild(this.createTextNode(
                feature.attributes.dgpsid));
            node.appendChild(dgpsid);
        } else {
            var number = this.createElementNSPlus('gpx:number');
            number.appendChild(this.createTextNode(
